...
=begin
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { country: @release.country, name: @release.name, release_date: @release.release_date } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { country: @release.country, name: @release.name, release_date: @release.release_date } }
